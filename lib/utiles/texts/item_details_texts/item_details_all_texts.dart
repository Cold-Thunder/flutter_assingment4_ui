class ItemDetailsAllTexts{
  static String itemAppBarTitle = 'Item Details';
  static String itemTitle = 'Fortune Sun Lite Refined Sunflower Oil';
  static String itemRating =  '4.0';
  static String itemRatingCount = '146';
  static String itemPrice = '\$12';
  ...
  static String date = 'April 10, 2023';
